/* Generated By:JJTree&JavaCC: Do not edit this line. Simp.java */
package parser.ast;
public class Simp/*@bgen(jjtree)*/implements SimpTreeConstants, SimpConstants {/*@bgen(jjtree)*/
  protected JJTSimpState jjtree = new JJTSimpState();
...
//
 ...
 jjtree.openNodeScope(jjtn000);Token t;
  ...
  public SimpTokenManager token_source;
  ...
  public Simp(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Simp(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new SimpTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Simp(java.io.Reader stream) {
  ...
  public Simp(SimpTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(SimpTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
